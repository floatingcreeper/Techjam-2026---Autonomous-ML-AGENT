...
# 5 feature fields. Add features here if you want to add them -- this is one of the main places for students to modify.
FIELDS = ['user_id', 'video_id', 'author_id', 'tab', 'dur_bucket']

def load(data_dir):
    """Read the logs + video-side features, return a dict split according to the official split."""
    vid2author = {}
...
def encode(splits):
    ...
    Returns (X, y, users) per split, X being int32 (N, len(FIELDS)), plus field_dims."""
    tr = splits['train']
