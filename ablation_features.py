"""Wire in CWM's 13 feature fields to verify whether user-side features are useful in the FM."""
...
def build(mode):
    """mode: 'base'=5 fields (current kit) / 'item'=only add item-side / 'cwm13'=all 13 CWM fields"""
