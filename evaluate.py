"""
KuaiRand-Pure official evaluation script -- all conventions are hard-coded here, do not change them.

Task            : within-user ranking (within-user ranking over logged impressions)
Relevance label : long_view (native column, 0/1)
Metrics         : GAUC, nDCG@5  (primary = the mean of the two)
Ranking scope   : each user only ranks their own impressions in the evaluation set, no full-corpus retrieval
Zero-positive users : nDCG counts as 0.0 and is included in the mean (consistent with CWM)
