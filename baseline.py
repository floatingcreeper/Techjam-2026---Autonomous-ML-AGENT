"""KuaiRand-Pure baselines.
  ...
  --model fm    : Factorization Machine (starting model, students improve upward from here)
  --model random: random scoring (lower bound, used to sanity-check that the evaluation code isn't broken)
...
if __name__ == '__main__':
    ...
    ap.add_argument('--data_dir', default='./KuaiRand-Pure/data',
                    help='the data directory of the extracted KuaiRand-Pure')
